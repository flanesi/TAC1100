...
/*
 * TAC1100: ModBus RTU client to read TAIYEQ TAC1100 series smart mini power meter registers
 *
 * Copyright (C) 2015 Gianfranco Di Prinzio <gianfrdp@inwind.it>
 * Copyright (C) 2023 Flavio Anesi <www.flanesi.it>
 * 
...
#define IAENERGY  0x0500
#define EAENERGY  0x0502
#define IRAENERGY 0x0508
#define ERAENERGY 0x050A
#define TAENERGY  0x0504
#define TRENERGY  0x050C
...
void usage(char* program) {
    printf("sdm120c %s: ModBus RTU client to read TAC1100 series smart mini power meter registers\n",version);
    printf("Copyright (C) 2023 Flavio Anesi\n");
